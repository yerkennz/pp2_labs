...
class MAIN:
    ...
    def game_over(self):
        current.execute(update,(len(self.snake.body)-3,username))
        current.close()
        config.commit()
        config.close() 
        pygame.quit()
...
apple = pygame.transform.scale(pygame.image.load("C:/Users/Nursultan/Documents/ncode/pp2/pp2_lab10snake/images/apple2.png"), (35,35)).convert_alpha()
game_font = pygame.font.Font("C:/Users/Nursultan/Documents/ncode/pp2/pp2_lab10snake/images/Papernotes Sketch.ttf", 25)
FPS = 150
level = 0
start = 0
